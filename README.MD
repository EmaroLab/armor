...
The full project including ARMOR, AMOR and the required ROS messages can be downloaded from this [**repository**](https://github.com/EmaroLab/ros_multi_ontology_references.git).
